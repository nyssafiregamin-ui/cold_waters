...
namespace Ceto
{
	...
	{
		// Token: 0x060005B3 RID: 1459 RVA: 0x0002625C File Offset: 0x0002445C
		private void Start()
		{
		...
		// Token: 0x060005B4 RID: 1460 RVA: 0x00026290 File Offset: 0x00024490
		private void OnGUI()
		{
			...
			if (component != null)
			{
				...
				num11 = GUILayout.HorizontalSlider(num11, 0.01f, 1f, new GUILayoutOption[0]);
				GUILayout.EndHorizontal();

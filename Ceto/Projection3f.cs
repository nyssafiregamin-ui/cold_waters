...
namespace Ceto
{
	...
	{
		// Token: 0x060003FF RID: 1023 RVA: 0x00018064 File Offset: 0x00016264
		...
		// (get) Token: 0x06000401 RID: 1025 RVA: 0x000182C8 File Offset: 0x000164C8
		...
		// Token: 0x06000402 RID: 1026 RVA: 0x000182CC File Offset: 0x000164CC
		...
		// Token: 0x06000403 RID: 1027 RVA: 0x00018440 File Offset: 0x00016640
		private void AimProjector(Camera cam)
		{
			...
			float num2 = Mathf.Max(0f, num + 10f);
			if (position.y < level)
			{
				position.y = level;
			}
		...
		// Token: 0x06000404 RID: 1028 RVA: 0x00018508 File Offset: 0x00016708
		...
		// Token: 0x06000405 RID: 1029 RVA: 0x000188C4 File Offset: 0x00016AC4
		...
		// Token: 0x06000406 RID: 1030 RVA: 0x00018940 File Offset: 0x00016B40
		...
		// Token: 0x06000407 RID: 1031 RVA: 0x00018998 File Offset: 0x00016B98
		public void LookAt(Vector3 position, Vector3 target, Vector3 up)
		{
			...
			ref Matrix4x4 ptr = ref this.m_projectorV;
			int num;
			int row = num = 0;
			int num2;
			int column = num2 = 0;
			float num3 = ptr[num, num2];
			this.m_projectorV[row, column] = num3 * -1f;
			ref Matrix4x4 ptr2 = ref this.m_projectorV;
			int row2 = num2 = 0;
			int column2 = num = 1;
			num3 = ptr2[num2, num];
			this.m_projectorV[row2, column2] = num3 * -1f;
			ref Matrix4x4 ptr3 = ref this.m_projectorV;
			int row3 = num = 0;
			int column3 = num2 = 2;
			num3 = ptr3[num, num2];
			this.m_projectorV[row3, column3] = num3 * -1f;
			ref Matrix4x4 ptr4 = ref this.m_projectorV;
			int row4 = num2 = 0;
			int column4 = num = 3;
			num3 = ptr4[num2, num];
